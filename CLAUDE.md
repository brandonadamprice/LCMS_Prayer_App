...
- **Run tests**:
    ...
    - Tests cover the pure, import-light modules (`streak_logic.py`,
      ...
      `signup_analytics_logic.py`, `psalter_logic.py`) and run without
